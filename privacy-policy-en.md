...
The App offers one-time (non-consumable) in-app products that unlock locked templates: category packs (`category_pack_<category>`, ₩1,500 / ~$1.19, 8 packs) and an unlock-all product (`premium_templates`, ₩2,500 / ~$1.99). None are subscriptions.
